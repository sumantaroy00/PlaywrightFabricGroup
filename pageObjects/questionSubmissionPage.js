...
class questionSubmissionPage {
        ...
        constructor(page) {  
            this.page = page;
            this.questionButton = page.locator(`xpath=//div[@class='bv-header']//button[text()=' Ask a question  ']`);
        ...
        async fillQuestionForm() {
            ...
            const niceName = randomGenerator.generateNiceName();
...
module.exports = questionSubmissionPage;
